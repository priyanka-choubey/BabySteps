...
this.c("test"))b.callback="(function(){})";b.ip=this.c("ip")?1:0;b._=(new Date).getTime().toString();a+="?"+c.qc(b);if("img"in b){var f=o.createElement("img");f.src=a;o.body.appendChild(f)}else if(T)try{var j=new XMLHttpRequest;j.open("GET",a,l);j.withCredentials=l;j.onreadystatechange=function(){if(4===j.readyState)if(200===j.status){if(d)if(e){var a;try{a=c.ma(j.responseText)}catch(b){q.error(b);return}d(a)}else d(Number(j.responseText))}else a="Bad HTTP status: "+j.status+" "+j.statusText,q.error(a),
d&&(e?d({status:0,error:a}):d(0))};j.send(m)}catch(g){q.error(g)}else{f=o.createElement("script");f.type="text/javascript";f.async=l;f.defer=l;f.src=a;var i=o.getElementsByTagName("script")[0];i.parentNode.insertBefore(f,i)}}};g.prototype.Ka=function(a){function b(a,b){c.a(a,function(a){this[a[0]].apply(this,a.slice(1))},b)}var d,e=[],f=[],j=[];c.a(a,function(a){a&&(d=a[0],"function"===typeof a?a.call(this):c.isArray(a)&&"alias"===d?e.push(a):c.isArray(a)&&-1!==d.indexOf("track")&&"function"===typeof this[d]?
j.push(a):f.push(a))},this);b(e,this);b(f,this);b(j,this)};g.prototype.push=function(a){this.Ka([a])};g.prototype.disable=function(a){"undefined"===typeof a?this.P.Xc=l:this.Ha=this.Ha.concat(a)};g.prototype.s=aa(function(a,b,d){"function"!==typeof d&&(d=C());if(c.d(a))q.error("No event name provided to mixpanel.track");else if(this.pb(a))d(0);else{b=b||{};b.token=this.c("token");var e=this.persistence.qd(a);c.d(e)||(b.$duration=parseFloat((((new Date).getTime()-e)/1E3).toFixed(3)));this.persistence.lc(o.referrer);
this.c("store_google")&&this.persistence.Id();this.c("save_referrer")&&this.persistence.kb(o.referrer);b=c.extend({},c.info.ha(),this.persistence.ha(),b);e=this.c("property_blacklist");c.isArray(e)?c.a(e,function(a){delete b[a]}):q.error("Invalid value for property_blacklist config: "+e);a=c.truncate({event:a,properties:b},255);e=c.na(a);e=c.zb(e);q.log("MIXPANEL REQUEST:");q.log(a);this.m(this.c("api_host")+"/track/",{data:e},this.ra(d,a));return a}});g.prototype.hc=function(a){if(c.d(a))a=o.location.href;
this.s("mp_page_view",c.info.od(a))};g.prototype.Hd=function(){return this.Qa.call(this,D,arguments)};g.prototype.Gd=function(){return this.Qa.call(this,M,arguments)};g.prototype.Cd=function(a){c.d(a)?q.error("No event name provided to mixpanel.time_event"):this.pb(a)||this.persistence.xd(a)};g.prototype.ia=function(a,b){this.persistence.ia(a,b)};g.prototype.D=function(a,b,c){this.persistence.D(a,b,c)};g.prototype.Ca=function(a){this.persistence.Ca(a)};g.prototype.Pa=function(a,b){var c={};c[a]=b;
this.ia(c)};g.prototype.$a=function(a,b,c,e,f,j,g){a!==this.U()&&a!==this.wa("__alias")&&(this.Ca("__alias"),this.Pa("distinct_id",a));this.mb(this.U());this.P.ab=l;this.people.Ac(b,c,e,f,j,g)};g.prototype.reset=function(){this.persistence.clear();this.P.ab=s;this.D({distinct_id:c.lb()},"")};g.prototype.U=function(){return this.wa("distinct_id")};g.prototype.Rc=function(a,b){if(a===this.wa("$people_distinct_id"))return q.T("Attempting to create alias for existing People user - aborting."),-2;var d=
